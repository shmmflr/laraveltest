<div class="admin-menu">
    <ul>
        ...
        <ul class="sub-category">
            <li><a href="{{route('category.index')}}">همه منو ها</a></li>
            <li><a href="{{route('category.create')}}">افزودن منو جدید</a></li>
        </ul>
        {{--افزودن مقاله جدید--}}
        ...
        <ul class="sub-article">
            <li><a href="{{route('article.index')}}">همه مقاله ها</a></li>
            <li><a href="{{route('article.create')}}">افزودن مقاله جدید</a></li>
        </ul>
    </ul>
</div>
